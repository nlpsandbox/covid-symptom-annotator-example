...
[![GitHub License](https://img.shields.io/github/license/nlpsandbox/covid-symptom-annotator-example.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/nlpsandbox/covid-symptom-annotator-example/blob/main/LICENSE)
...
This repository provides an example implementation of the [NLP Sandbox COVID
Symptom Annotator API] written in Python-Flask. An NLP Sandbox COVID symptom
annotator takes as input a clinical note (text) and outputs a list of predicted
COVID symptom annotations found in the clinical note. Here dates are identified
using regular expressions.

This tool is provided to NLP developers who develop in Python as a starting
point to package their own COVID symptom annotator as an NLP Sandbox tool (see
...
- Docker image: [docker.synapse.org/syn22277123/covid-symptom-annotator-example]
...
The command below starts this NLP Sandbox COVID symptom annotator locally.
...
Install and start this NLP Sandbox COVID symptom annotator.
...
This section describes how to develop your own NLP Sandbox COVID symptom annotator in
...
[nlpsandbox/covid-symptom-annotator-example-java].
...
languages and frameworks. Here a COVID symptom annotator stub refers to an initial
implementation that has been automatically generated by [openapi-generator] from
the [NLP Sandbox COVID Symptom Annotator API] specification.
...
Generate the COVID symptom annotator stub from an empty GitHub repository (here in
Python-Flask):
...
[docker.synapse.org/syn22277123/covid-symptom-annotator-example]: https://www.synapse.org/#!Synapse:syn25828638
[Synapse.org]: https://synapse.org
[openapi-generator]: https://github.com/OpenAPITools/openapi-generator
[contribution guide]: .github/CONTRIBUTING.md
[Apache License 2.0]: https://github.com/nlpsandbox/covid-symptom-annotator-example/blob/main/LICENSE
...
[NLP Sandbox COVID Symptom Annotator API]: https://nlpsandbox.github.io/nlpsandbox-schemas/date-annotator/latest/docs/
[this GitHub template]: https://github.com/nlpsandbox/covid-symptom-annotator-example/generate
